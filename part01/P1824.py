def solution(l):
    ...
    for n in l:
        ...
        r = r[:p] + t + r[p + 1 if insert else p:]
...
print(solution([16, 106, 101, 108, 108, 111, 37, 37, 37, 37, 37, 155, 16, 104]))
print(solution([20, 104, 16, 105, 32, 20, 16, 106, 97, 118, 97]))
print(solution([49, 51, 8, 50, 51, 53, 55, 37, 37, 127, 127, 52, 53]))
print(solution([20, 97, 98, 16, 99, 16, 100, 16, 49, 16, 50, 16, 51]))
